...
window.config = {
  ...
  defaultDataSourceName: 'my-backend',
  ...
  dataSources: [
    {
      ...
      sourceName: 'my-backend',
      configuration: {
        friendlyName: 'My Backend',
        name: 'my-backend',
        wadoUriRoot: 'http://localhost:8000/api/v1',
        qidoRoot: 'http://localhost:8000/api/v1',
        wadoRoot: 'http://localhost:8000/api/v1',
